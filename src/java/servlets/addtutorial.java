    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            */
            ...
            String qry1 = "INSERT INTO tutorials (tutorialcode,tutorialname,category,tutorialdescription,author) VALUES ( '"+tcode+"','"+tname+"','"+category+"','"+sol+"','"+author+"')";
            out.println(qry1);
            st.executeUpdate(qry1);
            con.close();
            response.sendRedirect("profile.jsp?SuccessTut=True");
        }catch(Exception e){}
