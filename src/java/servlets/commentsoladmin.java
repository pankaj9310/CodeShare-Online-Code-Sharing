 ...
 * @author aqfaridi
 */
public class commentsoladmin extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            */
            ...
            String qry = "INSERT INTO commentsource(problemcode,comment,username) VALUES('"+pcode+"','"+sol+"','"+user+"')";
            st.executeUpdate(qry);
            con.close();
            response.sendRedirect("adminsolutionview.jsp?id="+pcode+"&res="+res);
        }
        catch(Exception e){}
       finally {
            out.close();
