        ...
        <div class="container">
            <div class="row">
                ...
                <%
                    ...
                    String qry = "SELECT * FROM askquestions WHERE id='"+id+"'";
                    ...
                    if(rs.next())
                    {
                        ...
                        out.println("Question Title: "+rs.getString("questiontitle")+"<br/>");
                        out.println("Question Code: " + rs.getString("questioncode"));
                        out.println("</h2></center><br/>");
                        out.println(rs.getString("questiondescription")+"<br/>");

                        out.println("<p style = 'color:#808080;font-weight:bold;' > Asked By : <a>"+rs.getString("username")+"</a> "+rs.getString("time")+" </p><br/>");
                    }
                    %>
           ...
           <%
                qry = "SELECT * FROM commentquestions WHERE id='"+id+"' ORDER BY Sno DESC";
           ...
           <form action="commentask?id=<%=id%>" method="post">
