...
%>
            ...
            <%
                    ...
                    %>
           <a class="btn btn-info btn-block " href="./previewsolution.jsp?id=<%=pcode%>&res=<%=res%>" style="color:white;font-weight: bold;text-decoration: none;">View Source</a>
           <br/><br/>
           ...
           <form action="comment?id=<%=pcode%>&res=<%=res%>" method="post">
